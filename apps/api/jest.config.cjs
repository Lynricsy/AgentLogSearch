module.exports = {
  ...
  moduleNameMapper: {
    ...
    "^\\./(cargo-test-output-parser|generic-process-parser|go-test-output-parser|jest-output-parser|pytest-output-parser|validation-output-parser|vitest-output-parser)\\.js$":
